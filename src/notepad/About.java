...
public class About extends JFrame implements ActionListener {
    ...
    About() {
        ...
        // Set custom icon for About window
        ...
        JLabel l3 = new JLabel("<html>Nazmeen Khan!<br>My first desktop-based application.<br>Notepad Clone made by Nazmeen Khan. All rights reserved.<br><br>Notepad is a word processing program, <br>which allows changing of text in a computer file.<br>Notepad is a simple text editor for basic text-editing program<br>which enables computer users to create documents.</html>");
